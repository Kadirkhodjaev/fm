...
<table style="border-collapse: collapse; border-spacing:0;">
  <tr style="border:0">
    <td colspan="5">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px;">УТВЕРЖДАЮ</td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px;">Директор "${clinic_name}"</td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px">${boss.fio}</td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td><td colspan="3" style="text-align: center;border-width: thin; border-bottom-color: black; border-bottom-style: solid;">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="8">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td style="font-weight:bold; text-align: center; font-size:18px;" colspan="8">Акт выполненых работ № ${obj.actNum}</td>
  </tr>
  <tr>
    <td style="font-weight:bold; text-align: center; font-size:14px" colspan="8">от <fmt:formatDate pattern = "dd.MM.yyyy" value = "${obj.dateEnd}" />г.</td>
  </tr>
  <tr>
    <td style="font-weight:bold; text-align: center; font-size:14px" colspan="8">к договору № ${obj.patient.contractNum} от <fmt:formatDate pattern = "dd.MM.yyyy" value = "${obj.patient.dateBegin}" />г.</td>
  </tr>
  <tr>
    <td colspan="8">&nbsp;</td>
  </tr>
  <tr style="font-size: 14px">
    <td colspan="5" style="font-weight: bold; text-align: center; border-width: thin; border-color: black; border-style: solid;">Общая терапия</td>
  ...
  <tr style="font-size: 14px">
    <td colspan="3" style="font-weight: bold; text-align: center; border-width: thin; border-color: black; border-style: solid;">ФИО</td>
  ...
  <tr style="font-size: 14px">
    <td colspan="3" style="font-weight: bold; text-align: center; border-width: thin; border-color: black; border-style: solid;">Дата поступления</td>
  ...
  <tr style="font-size: 14px">
    <td colspan="3" style="font-weight: bold; text-align: center; border-width: thin; border-color: black; border-style: solid;">Наличные</td>
  ...
  <c:if test="${fn:length(drugs) > 0}">
    <tr style="font-size: 14px">
      <td style="font-weight:bold; text-align: center;" colspan="8">Медикаменты</td>
    </tr>
    <tr style="font-size: 14px">
      ...
      <td align="center" style="font-weight: bold; border-width: thin; border-color: black; border-style: solid;">С НДС</td>
    ...
    <c:forEach items="${drugs}" var="row" varStatus="loop">
      <tr style="font-size: 14px">
        ...
        <td align="right" style="border-width: thin; border-color: black; border-style: solid;"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${row.price + row.nds}"/></td>
        <td align="right" style="border-width: thin; border-color: black; border-style: solid;"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(row.price + row.nds)*row.serviceCount}"/></td>
      </tr>
    </c:forEach>
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">ИТОГО</td>
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
  ...
  <c:if test="${fn:length(labs) > 0}">
    <tr style="font-size: 14px">
      <td style="font-weight:bold; text-align: center;" colspan="8">Лабораторные исследования</td>
    </tr>
    <c:forEach items="${labs}" var="elem" varStatus="loop">
      <tr style="font-size: 14px">
        ...
        <td align="right" style="border-width: thin; border-color: black; border-style: solid;"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(elem.price + elem.nds)*elem.serviceCount}"/></td>
      </tr>
    </c:forEach>
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
  ...
  <c:if test="${fn:length(consuls) > 0}">
    <tr style="font-size: 14px">
      <td style="font-weight:bold; text-align: center;" colspan="8">Узкие специалисты</td>
    </tr>
  ...
  <c:if test="${fn:length(kdos) > 0}">
    <tr style="font-size: 14px">
      <td style="font-weight:bold; text-align: center;" colspan="8">Медицинские услуги</td>
    </tr>
    <c:forEach items="${kdos}" var="elem" varStatus="loop">
      <tr style="font-size: 14px">
        ...
        <td style="border-width: thin; border-color: black; border-style: solid; text-align: right"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(elem.price+elem.nds)*elem.serviceCount}"/></td>
      </tr>
    </c:forEach>
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
  ...
  <c:if test="${fn:length(epics) > 0}">
    <c:forEach items="${epics}" var="epic">
      <tr style="font-size: 14px">
        <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
        <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Стоимость палаты: ${epic.c1}</td>
        ...
        <td style="border-width: thin; border-color: black; border-style: solid;font-weight: bold; text-align: right"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(epic.c5+epic.c7)*epic.c6}"/></td>
      </tr>
    </c:forEach>
  </c:if>
  <c:if test="${fn:length(epics) == 0}">
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Стоимость палаты: ${obj.patient.dept.name}</td>
  ...
  <c:forEach items="${watchers}" var="watcher" varStatus="loop">
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Дополнительное место</td>
      ...
      <td style="border-width: thin; border-color: black; border-style: solid;font-weight: bold; text-align: right"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${watcher.dayCount*(watcher.price + watcher.nds)}"/></td>
    </tr>
  </c:forEach>
  <c:if test="${dis_perc > 0}">
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Стоимость палаты с учетом скидки</td>
  ...
  <c:if test="${discount_sum > 0}">
    <tr style="font-size: 14px">
      <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
      <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Мед. услуги входящие стоимость койки</td>
  ...
  <tr style="font-size: 14px">
    <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
    <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Питание</td>
    <td style="border-width: thin; border-color: black; border-style: solid;text-align: center"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${obj.dayCount}"/></td>
  ...
  <tr style="font-size: 14px">
    <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
    <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Медикаменты на сумму</td>
    <td style="border-width: thin; border-color: black; border-style: solid;text-align: center">&nbsp;</td>
  ...
  <tr style="font-size: 14px">
    <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
    <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Медицинские услуги на сумму</td>
    <td style="border-width: thin; border-color: black; border-style: solid;text-align: center">&nbsp;</td>
    <td style="border-width: thin; border-color: black; border-style: solid;font-weight: bold">&nbsp;</td>
  ...
  <tr style="font-size: 14px">
    <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
    <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">Всего с НДС</td>
    <td style="border-width: thin; border-color: black; border-style: solid;text-align: center">&nbsp;</td>
    <td style="border-width: thin; border-color: black; border-style: solid;font-weight: bold">&nbsp;</td>
  ...
  <tr style="font-size: 14px">
    <td style="border-width: thin; border-color: black; border-style: solid;">&nbsp;</td>
    <td colspan="4" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold">К доплате</td>
    <td style="border-width: thin; border-color: black; border-style: solid;text-align: center">&nbsp;</td>
    <td style="border-width: thin; border-color: black; border-style: solid;font-weight: bold">&nbsp;</td>
  ...
  <tr style="font-size: 14px">
    <td colspan="3" style="border-width: thin; border-color: black; border-style: solid; font-weight:bold; text-align: center; vertical-align: middle">Сумма прописью:</td>
  ...
  <tr style="font-size: 14px">
    ...
    <td style="border-bottom-width: thin; border-bottom-color: black; border-bottom-style: solid;" colspan="3">&nbsp;</td>
