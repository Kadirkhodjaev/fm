...
<table style="border-collapse: collapse; border-spacing:0;">
  <tr style="border:0">
    <td colspan="4">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px;">УТВЕРЖДАЮ</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px;">Директор "${clinic_name}"</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td><td colspan="3" style="text-align: center; font-size:14px">${boss.fio}</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td><td colspan="3" style="text-align: center;border-width: thin; border-bottom-color: black; border-bottom-style: solid;">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="7">&nbsp;</td>
  </tr>
  ...
  <c:if test="${fn:length(labs) > 0}">
    ...
    <c:forEach items="${labs}" var="elem" varStatus="loop">
      <tr style="font-size: 14px">
        ...
        <td align="right" style="border-width: thin; border-color: black; border-style: solid;"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(elem.price == 0 ? elem.real_price : elem.price) * (100 + ndsProc) / 100}"/></td>
  ...
  <c:if test="${fn:length(kdos) > 0}">
    ...
    <c:forEach items="${kdos}" var="elem" varStatus="loop">
      <tr style="font-size: 14px">
        ...
        <td colspan="3" style="border-width: thin; border-color: black; border-style: solid;">${elem.serviceName}</td>
        <td align="center" style="border-width: thin; border-color: black; border-style: solid;"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${elem.serviceCount}"/></td>
        <td style="border-width: thin; border-color: black; border-style: solid; text-align: right"><fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" type="number" value="${(elem.price == 0 ? elem.real_price : elem.price) * (100 + ndsProc) / 100}"/></td>
