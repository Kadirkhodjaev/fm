...
<div class="panel panel-info" style="width: 100%; margin: auto">
  <div class="panel-heading">
    Анализ прихода по медикаментам
  </div>
  <div class="panel-body">
    <table class="table table-bordered miniGrid">
      <tr>
        ...
        <th rowspan="2" style="vertical-align: middle">Дата прихода</th>
        <th rowspan="2" style="vertical-align: middle">Кол-во недель</th>
        <th colspan="2" style="vertical-align: middle">Общий расход</th>
        <th colspan="2" style="vertical-align: middle">Остаток</th>
        <th colspan="2" style="vertical-align: middle">Расход за неделю</th>
