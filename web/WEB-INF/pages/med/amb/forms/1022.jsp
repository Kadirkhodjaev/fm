  ...
  <div class="" style="margin-left:-1px; width: 100% !important;">
    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        <tr>
          <td colspan="6" class="center" style="padding:5px">Обнаруженные микроорганизмы</td>
          <td colspan="2" class="center" style="padding:5px">KOE</td>
        </tr>
        <tr>
          <td colspan="6" rowspan="2" class="center" style="padding:5px">Serratia marcescens</td>
          <td colspan="2" class="center" style="padding:5px">KOE 10<sup>5</sup></td>
        </tr>
        <tr>
          <td colspan="2" class="center" style="padding:5px">KOE</td>
        </tr>
        <tr>
          <td class="center bold">Антибиотик</td>
          <td class="center bold" nowrap>Ум. устойчивы</td>
          <td class="center bold">Устойчивый</td>
          <td class="center bold">Чувствительный</td>
          <td class="center bold">Антибиотик</td>
          <td class="center bold" nowrap>Ум. устойчивы</td>
          <td class="center bold">Устойчивый</td>
          <td class="center bold">Чувствительный</td>
        ...
        <c:forEach begin="0" end="63" step="3" var="field">
          <tr>
            <td style="padding:5px;text-align:left">${fields[field].name}</td>
            <td style="padding:5px">${fields[field].html}</td>
            <td style="padding:5px">${fields[field + 1].html}</td>
            <td style="padding:5px">${fields[field + 2].html}</td>

            <td style="padding:5px;text-align:left">${fields[field + 63].name}</td>
            <td style="padding:5px">${fields[field + 63].html}</td>
            <td style="padding:5px">${fields[field + 64].html}</td>
            <td style="padding:5px">${fields[field + 64].html}</td>
          </tr>
        </c:forEach>
      </table>
