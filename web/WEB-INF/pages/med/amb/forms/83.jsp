  ...
  <div class="" style="margin-left:-1px; width: 100% !important;">
    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        ...
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[42].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[42].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[43].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[44].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[44].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[45].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[46].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[46].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[47].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[48].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[48].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[49].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[50].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[50].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[51].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[52].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[52].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[53].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[54].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[54].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[55].html}</td>
        </tr>
        <tr>
          <td style="padding:5px; border:1px solid #e8e8e8">${fields[56].name}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[56].html}</td>
          <td style="border:1px solid #e8e8e8; padding:5px">${fields[57].html}</td>
        </tr>
      </table>
    </form>
  </div>
