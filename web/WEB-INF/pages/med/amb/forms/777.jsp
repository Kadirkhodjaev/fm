    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        ...
        <c:forEach items="${fields}" var="field">
          <tr>
            <td style="padding:5px;text-align:right">${service.service.name}</td>
            <td style="padding:5px">${field.html}</td>
            <td class="center" style="padding:5px">${field.norma}</td>
            <td class="center" style="padding:5px">${field.ei}</td>
          </tr>
        </c:forEach>
      </table>
    </form>
