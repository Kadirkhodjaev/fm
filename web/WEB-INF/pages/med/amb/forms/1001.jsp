    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        ...
        <tr>
          ...
          <td class="center bold">Ед. изм.</td>
        </tr>
        <c:forEach begin="0" end="13" step="1" var="r">
          <tr>
            <td style="padding:5px;text-align:right">${fields[r].name}</td>
            <td style="padding:5px">${fields[r].html}</td>
            <td class="center" style="padding:5px">${fields[r].norma}</td>
            <td class="center" style="padding:5px">${fields[r].ei}</td>
          </tr>
        </c:forEach>
        <tr>
