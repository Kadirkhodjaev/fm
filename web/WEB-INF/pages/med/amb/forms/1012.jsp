    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        <tr>
          ...
          <td class="center bold">lg G</td>
          <td class="center bold">lg M</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:5px;text-align:right">${fields[2].name}</td>
          <td style="padding:5px">${fields[2].html}</td>
          <td style="padding:5px">${fields[3].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[4].name}</td>
