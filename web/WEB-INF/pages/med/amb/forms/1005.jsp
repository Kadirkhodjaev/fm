    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        <tr>
          ...
          <td class="center bold">ur</td>
          <td class="center bold">cer</td>
          <td class="center bold">vag</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[0].name}</td>
          <td style="padding:5px">${fields[0].html}</td>
          <td style="padding:5px">${fields[1].html}</td>
          <td style="padding:5px">${fields[2].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[3].name}</td>
          <td style="padding:5px">${fields[3].html}</td>
          <td style="padding:5px">${fields[4].html}</td>
          <td style="padding:5px">${fields[5].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[6].name}</td>
          <td style="padding:5px">${fields[6].html}</td>
          <td style="padding:5px">${fields[7].html}</td>
          <td style="padding:5px">${fields[8].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[9].name}</td>
          <td style="padding:5px">${fields[9].html}</td>
          <td style="padding:5px">${fields[10].html}</td>
          <td style="padding:5px">${fields[11].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[12].name}</td>
          <td style="padding:5px">${fields[12].html}</td>
          <td style="padding:5px">${fields[13].html}</td>
          <td style="padding:5px">${fields[14].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[15].name}</td>
          <td style="padding:5px">${fields[15].html}</td>
          <td style="padding:5px">${fields[16].html}</td>
          <td style="padding:5px">${fields[17].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[18].name}</td>
          <td style="padding:5px">${fields[18].html}</td>
          <td style="padding:5px">${fields[19].html}</td>
          <td style="padding:5px">${fields[20].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[21].name}</td>
          <td style="padding:5px">${fields[21].html}</td>
          <td style="padding:5px">${fields[22].html}</td>
          <td style="padding:5px">${fields[23].html}</td>
        </tr>
      </table>
    </form>
  </div>
