...
<div class="panel panel-info" style="width: 700px !important; margin: auto">
  ...
  <div class="panel-body">
    <table class="formTable" style="width:100%">
      ...
      <tr>
        <td class="right bold" nowrap>Дата и время:</td>
        <td colspan="3"><fmt:formatDate pattern = "dd.MM.yyyy HH:mm" value = "${service.confDate}"/></td>
      </tr>
    </table>
  </div>
    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        <tr>
          ...
          <td class="center bold">Резултат</td>
        </tr>
