  ...
  <div class="" style="margin-left:-1px; width: 100% !important;">
    ...
    <form id="amb-form">
      ...
      <table width="100%" class="table-bordered">
        <tr>
          <td class="center bold">Время</td>
          <td class="center bold">Удельный вес</td>
          <td class="center bold">Количество мочи (мл)</td>
          <td class="center bold">Диурез</td>
        </tr>
        <tr>
          ...
          <td rowspan="2" class="center" style="padding:5px">
            Дневной диурез<br/>
            ДД = ${fields[2].html} мл
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:5px;text-align:right">${fields[5].name}</td>
          <td style="padding:5px">${fields[5].html}</td>
          <td style="padding:5px">${fields[6].html}</td>
          <td rowspan="3" class="center" style="padding:5px">
            Ночной диурез<br/>
            ДД = ${fields[7].html} мл
          </td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[8].name}</td>
          <td style="padding:5px">${fields[8].html}</td>
          <td style="padding:5px">${fields[9].html}</td>
        </tr>
        <tr>
          <td style="padding:5px;text-align:right">${fields[10].name}</td>
        ...
        <tr>
          <td style="padding:5px;text-align:right">${fields[17].name}</td>
