...
<table style="width:100%;border-spacing: 0; border-collapse: collapse">
  ...
  <tr>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">Œœ–≈ƒ≈Àﬂ≈Ã€≈ Ã» –ŒŒ–√¿Õ»«Ã»</td>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px" colspan="2"> ŒÀŒ–ŒÃ»“–»◊≈— ¿ﬂ –≈¿ ÷»ﬂ</td>
  </tr>
  <tr>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px"></td>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">œŒÀŒ∆»“≈À‹Õ€…</td>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">Œ“–»÷¿“≈À‹Õ€…</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">“≈—“ Õ¿ ¿Õ“»¡¿ “≈–»¿À‹Õ”ﬁ ◊”¬—“¬»“≈À‹ÕŒ—“</td>
  </tr>
  <tr>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px"></td>
  ...
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[46].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[46].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[47].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[48].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[48].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[49].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[50].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[50].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[51].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[52].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[52].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[53].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[54].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[54].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[55].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[56].name}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[56].html}</td>
    <td style="border:1px solid #e8e8e8; padding:5px">${ser.fields[57].html}</td>
  </tr>
  <tr>
    <td colspan="4" style="padding:20px 0;font-weight:bold">
      <table width="100%">
        <tr>
          <td width="50%" style="font-weight:bold;padding-left:20px;">¬‡˜</td>
