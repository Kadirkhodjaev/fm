...
<table style="width:100%;border-spacing: 0; border-collapse: collapse">
  ...
  <tr>
    ...
    <td style="text-align:center;border:1px solid #e8e8e8; padding:5px">${ser.fields[42].html}</td>
    <td style="text-align:center;border:1px solid #e8e8e8; padding:5px">${ser.fields[43].html}</td>
  </tr>
  <tr>
    <td style="padding:5px; border:1px solid #e8e8e8">${ser.fields[44].name}</td>
    <td style="text-align:center;border:1px solid #e8e8e8; padding:5px">${ser.fields[44].html}</td>
    <td style="text-align:center;border:1px solid #e8e8e8; padding:5px">${ser.fields[45].html}</td>
  </tr>
  <tr>
