...
<table style="width:100%;border-spacing: 0; border-collapse: collapse">
  ...
  <tr>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">Îïğåäåëÿåìûå ïàğàìåòğû</td>
  ...
  <tr>
    ...
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">ÂÛßÂËÅÍÎ</td>
    <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">ÍÅ ÂÛßÂËÅÍÎ</td>
  </tr>
  <tr>
