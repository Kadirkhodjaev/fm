...
<table style="width:95%; margin: auto; border-spacing:0; border-collapse:collapse;">
  <tr>
    <td colspan="4" align="center"><b>КОНСУЛЬТАЦИЯЛАР</b></td>
  </tr>
  <tr>
    <td colspan="4"><br/></td>
  </tr>
  ...
  <c:forEach items="${consuls}" var="c">
    <c:if test="${c.text != null}">
      ...
      <tr>
        <td nowrap style="border:1px solid #ababab; padding:4px"><b>Шифокор:</b> ${c.lvName}</td>
        <td nowrap style="border:1px solid #ababab; padding:4px"><b>Консультация санаси: </b>${c.date}</td>
      </tr>
      <tr>
