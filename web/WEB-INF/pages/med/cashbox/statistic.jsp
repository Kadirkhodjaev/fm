...
<script>
  function setCashStat(){
    ...
    setPage('/cashbox/statistic.s?period_start=' + start.value + '&period_end=' + end.value);
  }
...
<div class="panel panel-info">
  <!-- /.panel-heading -->
  <div class="panel-heading bold">
    ВСЕГО: <a href="#" onclick="openDetails('amb'); return false"><span style="font-weight:bold; color:red; font-size:15px"><fmt:formatNumber value="${obj.c10 + obj.c20}" type = "number"/></span></a>
  </div>
          ...
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-xs-6 text-right">
                <p class="announcement-heading" style="font-size:20px"><fmt:formatNumber value="${obj.c1 + obj.c5}" type = "number"/></p>
              </div>
            </div>
          </div>
        ...
        <div class="panel panel-green">
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-xs-6 text-right">
                <p class="announcement-heading" style="font-size:20px"><fmt:formatNumber value="${obj.c3 + obj.c7}" type = "number"/></p>
              </div>
            </div>
          </div>
          <a href="#" onclick="return false;">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-xs-6 text-right">
                <p class="announcement-heading" style="font-size:20px"><fmt:formatNumber value="${obj.c4 + obj.c8}" type = "number"/></p>
              </div>
            </div>
          </div>
          <a href="#" onclick="return false;">
