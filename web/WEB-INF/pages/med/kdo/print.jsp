...
<iframe style="margin-top:-10px; width: 100%; height:94% !important; position: absolute" name="frm" src="/kdo/obs.s?print=Y&id=${id}&kdo=${kdoId}&font=${sessionScope.fontSize}"></iframe>
</body>
</html>