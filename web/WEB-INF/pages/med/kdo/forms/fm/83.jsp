...
<tr>
  ...
  <td style="border:1px solid #e8e8e8; padding:5px">${c30html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c31name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c31html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c32html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c33name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c33html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c34html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c35name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c35html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c36html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c37name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c37html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c38html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c39name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c39html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c40html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c41name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c41html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c42html}</td>
</tr>
<tr>
  <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px"></td>
  <td style="text-align: center; font-weight: bold; border:1px solid #e8e8e8; padding:5px">ПОЛОЖИТЕЛЬНЫЙ</td>
...
<tr>
  ...
  <td style="border:1px solid #e8e8e8; padding:5px">${c43html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c44html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c45name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c45html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c46html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c47name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c47html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c48html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c49name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c49html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c50html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c51name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c51html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c52html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c53name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c53html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c54html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c55name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c55html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c56html}</td>
</tr>
<tr>
  <td style="padding:5px; border:1px solid #e8e8e8">${c57name}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c57html}</td>
  <td style="border:1px solid #e8e8e8; padding:5px">${c58html}</td>
</tr>
