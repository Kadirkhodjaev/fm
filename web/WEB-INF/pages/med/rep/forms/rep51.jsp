...
<table border="1" width="100%">
  <tr>
    ...
    <td nowrap style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Посл. дата рег</td>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">ЛВ</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Страна</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Регион</td>
  ...
  <c:forEach items="${rows}" var="service" varStatus="loop">
    <tr>
      ...
      <td align="left" style="padding:5px;">${service.c4}</td>
      <td align="center" style="padding:5px;">${service.c5}</td>
      <td align="left" nowrap style="padding:5px;">${service.c6}</td>
