...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Лейкоциты (Z)</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Эритроцитлар (Эр)</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Цилиндрлар</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Нечипоренко</td>
  </tr>
