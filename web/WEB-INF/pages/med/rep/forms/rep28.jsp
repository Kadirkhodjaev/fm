...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Умумий холестерин</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Триглицеридлар</td>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Атерогенлик коэффициенти</td>
  </tr>
