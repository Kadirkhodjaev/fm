...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">ВПГ</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">ЦМВ</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Токсоплазма</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Хламидия</td>
  </tr>
