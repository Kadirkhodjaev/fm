...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">ТТГ</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Т4</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Т3</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Анти - ТРО</td>
  </tr>
