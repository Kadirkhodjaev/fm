...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Количество</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Удельный вес</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Сахар</td>
  </tr>
