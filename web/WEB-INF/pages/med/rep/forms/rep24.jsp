...
<table border="1" width="100%">
  <tr>
    ...
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Протромбин вакти</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">ПТИ (Квик буйича вакт)</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">МНО</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Фибриноген</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">Тромбин вакти</td>
    <td style="font-weight:bold;padding:5px;background:#e8e8e8;" align="center">А.Ч.Т.В.(сек)</td>
  </tr>
