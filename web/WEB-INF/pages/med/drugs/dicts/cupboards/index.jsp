      ...
      <table class="miniGrid table table-striped table-bordered">
        ...
        <c:forEach items="${list}" var="obj">
          <tr>
            ...
            <td align="center">${obj.storage.name}</td>
            <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Реквизиты шкафа</h4>
      </div>
      <div class="modal-body">
        <form id="addEditForm" name="addEditForm">
          <input type="hidden" name="id" value="" />
          <input type="hidden" name="code" value="cupboard" />
          <table class="table table-bordered">
            <tr>
              <td class="right bold">Склад*:</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input type="text" id="cupboard-name" class="form-control" name="name" value=""/>
              </td>
            </tr>
            <tr>
