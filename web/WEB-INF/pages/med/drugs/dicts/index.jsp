...
<div class="panel panel-info">
  <div class="panel-body">
    <ul class="nav nav-tabs">
      ...
      <%--<li class="<c:if test="${sessionScope.ENV.curSubUrl == '/drugs/dict/storages.s'}">active</c:if>"><a href="#page_storages" data-toggle="tab" onclick="dictPage('storages')" aria-expanded="${sessionScope.ENV.curSubUrl == '/drugs/dict/storages.s'}">Склады</a></li>
      <li class="<c:if test="${sessionScope.ENV.curSubUrl == '/drugs/dict/cupboards.s'}">active</c:if>"><a href="#page_cupboards" data-toggle="tab" onclick="dictPage('cupboards')" aria-expanded="${sessionScope.ENV.curSubUrl == '/drugs/dict/cupboards.s'}">Шкафы</a></li>--%>
